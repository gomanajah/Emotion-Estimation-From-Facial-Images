...
% Last Modified by GUIDE v2.5 23-Sep-2016 02:22:24
...
Expressions={'Angry','Contempt','Disgusted','Fear','Happy','Neutral','Sad','Surprised','Total'};
   global knn_Result
   global Test_Class
if FE==handles.radiobutton1 && CL==handles.radiobutton3
            [Sheet_Na,Angry,contempt,Disgusted,Fear,Happy,Neutral,Sad,Surprised,Total,knn_Result,Test_Class,False_Expr]=HOG_KNN(CS);
elseif FE==handles.radiobutton1 && CL==handles.radiobutton4
            [Sheet_Na,Angry,contempt,Disgusted,Fear,Happy,Neutral,Sad,Surprised,Total,knn_Result,Test_Class,False_Expr]=HOG_SVM(CS);
elseif FE==handles.radiobutton2 && CL==handles.radiobutton3
            [Sheet_Na,Angry,contempt,Disgusted,Fear,Happy,Neutral,Sad,Surprised,Total,knn_Result,Test_Class,False_Expr]=LBP_KNN(CS);
elseif FE==handles.radiobutton2 && CL==handles.radiobutton4
            [Sheet_Na,Angry,contempt,Disgusted,Fear,Happy,Neutral,Sad,Surprised,Total,knn_Result,Test_Class,False_Expr]=LBP_SVM(CS);
end
% assignin('base','knn_Result',knn_Result);
% assignin('base','Test_Class',Test_Class);
All=vertcat(Angry,contempt,Disgusted,Fear,Happy,Neutral,Sad,Surprised,Total);
%% Select file name By (Cell Size & Database name)
filename = [pwd '\TFEID.xlsx'];
[Sheet_Na1] = Select_DB(CS,Sheet_Na);
%% ============================================================
set(handles.uitable1,'Data',All,'ColumnName',Header,'RowName',Expressions);
%% 
FE1 = get(handles.checkbox1,'Value');
if FE1==1
Export(filename,Sheet_Na1,Angry,contempt,Disgusted,Fear,Happy,Neutral,Sad,Surprised,False_Expr)
end
