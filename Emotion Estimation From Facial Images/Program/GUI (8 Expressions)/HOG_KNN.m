function [Sheet_Na,Angry,contempt,Disgusted,Fear,Happy,Neutral,Sad,Surprised,Total,knn_Result,Test_Class,False_Expr] = HOG_KNN(CS)
clc
...
Sheet_Na='HOG+KNN'; %Name of sheet
%%  ******************************Print OUT********************************
Percent='%';
fprintf('===================================================================\n');
