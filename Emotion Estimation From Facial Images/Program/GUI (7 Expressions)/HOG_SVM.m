function [Sheet_Na,Angry,Disgusted,Fear,Happy,Neutral,Sad,Surprised,Total,MultiSVM_result,Test_Class,False_Expr] = HOG_SVM(CS,Train_Angry_Folder,Train_Disgusted_Folder,Train_Fear_Folder,Train_Happy_Folder,Train_Neutral_Folder,Train_Sad_Folder,Train_Surprised_Folder,Test_Angry_Folder,Test_Disgusted_Folder,Test_Fear_Folder,Test_Happy_Folder,Test_Neutral_Folder,Test_Sad_Folder,Test_Surprised_Folder)
clc
%%  *********************** Call HOG Functions ******************************
